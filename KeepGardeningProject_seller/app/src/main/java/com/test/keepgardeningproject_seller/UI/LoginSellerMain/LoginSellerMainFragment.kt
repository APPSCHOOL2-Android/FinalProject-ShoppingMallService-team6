...
class LoginSellerMainFragment : Fragment() {
    ...
    companion object {
        fun newInstance() = LoginSellerMainFragment()
    }

    private lateinit var viewModel: LoginSellerMainViewModel
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProvider(this).get(LoginSellerMainViewModel::class.java)
